...
def get_beatmaps(key, since, set_id, beatmap_id, user_id):
	...
	#print(str(build_request(list_of_params, "https://osu.ppy.sh/api/get_beatmaps?")))
...
def get_user_best(key, user_id, mode, limit, type):
	...
	#print(str(build_request(list_of_params, "https://osu.ppy.sh/api/get_user_best?")))
...
def get_user_recent(key, user_id, mode, type):
	...
	## Build the full request URL and return the response.
	#print((build_request(list_of_params, "https://osu.ppy.sh/api/get_user_recent?")))
...
#print(str(get_user_recent("84d15a0b2e5c0930de9126cccb13c9cb96909a07", "-fISH-", 0, "string")))
#print(str(get_beatmaps("84d15a0b2e5c0930de9126cccb13c9cb96909a07", "", "", "1621175", "")))
#print(str(get_user_best("84d15a0b2e5c0930de9126cccb13c9cb96909a07", "-fISH-", 0, 10, "string")))
#https://osu.ppy.sh/images/badges/score-ranks/Score-SSPlus-Small-60.png
#https://osu.ppy.sh/images/badges/score-ranks/Score-SS-Small-60.png
#https://osu.ppy.sh/images/badges/score-ranks/Score-SPlus-Small-60.png
#https://osu.ppy.sh/images/badges/score-ranks/Score-S-Small-60.png
#https://osu.ppy.sh/images/badges/score-ranks/Score-C-Small-60.png
#https://osu.ppy.sh/images/badges/score-ranks/Score-B-Small-60.png
#https://osu.ppy.sh/images/badges/score-ranks/Score-A-Small-60.png
#https://osu.ppy.sh/images/badges/score-ranks/Score-F-Small-60.png
